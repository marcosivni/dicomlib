...
*/
...
#else
	typedef boost::function<bool(const std::string&)> StringCheckFunction;
	...
	*/
	class Server
	{
		...
		*/
		StringCheckFunction CheckRemoteAET;
	...
	public:
		...
		void SetCheckRemoteAETCallback(StringCheckFunction f);
		...
		bool IsAcceptableRemoteApplicationTitle		(const std::string& Title);
