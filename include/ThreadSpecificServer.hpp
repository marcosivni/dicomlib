	...
	namespace Implementation
	{
		...
		*/
		...
		struct ThreadSpecificServer : public ServiceBase
		{
			...
			//!This is used together with callbacks to inform the application of the status of the server.
			/*!
				An alternative approach would be to require the application programmer
				to use thread-specific storage to keep track of this.
			*/
//			int association_identifier_;
